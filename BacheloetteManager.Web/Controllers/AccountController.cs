...
using BacheloetteManager.Web.Models;
using BacheloetteManager.Web.Models.AccountViewModels;
...
namespace Project.BacheloretteManagerWeb.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public IActionResult Login(string returnUrl = null)
        {
            ...
            ViewData["Title"] = "Login Professor";
            return View();
        }
        ...
        public async Task<IActionResult> RegisterStudent(RegisterStudentViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new Student { Id = new Guid(),
                                        FirstName = model.Prenume,
                                        LastName = model.Nume,
                                        Password = model.Password,
                                        Role = 2,
                                        MeanA1 = model.MedAn1,
                                        MeanA2 = model.MedAn2,
                                        Preferences = model.Preferinte};
        ...
        public async Task<IActionResult> RegisterTeacher(RegisterTeacherViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new Teacher {
                    ...
                    Password = model.Password,
                    Role = 2,
                    FreeSpaces = model.NrLocuri,
                    Available = 1,
                    Requirements = model.Cerinte
                };
